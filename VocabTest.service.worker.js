...
/** @type {string} */
const CACHE_VERSION = '1770832572|10330483421';
/** @type {string} */
const CACHE_PREFIX = 'VocabTest-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'VocabTest.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["VocabTest.html","VocabTest.js","VocabTest.offline.html","VocabTest.icon.png","VocabTest.apple-touch-icon.png","VocabTest.audio.worklet.js","VocabTest.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["VocabTest.wasm","VocabTest.pck"];
